...
Lecture : les sections 3 a 8 decrivent les constats de la fenetre initiale et
leurs corrections successives. Les phrases au present de l'audit ne sont pas
une nouvelle observation du code. L'etat de reprise est la table de la section 9.
...
Lors de cette qualification, App Hosting servait `sv-mtlle76d-daa1d98532b0`. Les revisions finales des deux
...
## 10. Limites du diagnostic initial, avant les corrections de la section 9
...
- aucun correctif runtime n'avait encore ete applique au stade du diagnostic.
