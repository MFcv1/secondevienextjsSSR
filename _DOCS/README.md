...
| revamp page Ventes | [REVAMP_VENTES.md](admin/REVAMP_VENTES.md) | `SPEC_IMPLEMENTATION_ACTIVE`, diagnostic, modele d'etat et decoupage livres | fusion dans BACKOFFICE.md puis suppression une fois la vue stabilisee |
