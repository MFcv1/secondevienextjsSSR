...
## 2. Baseline avant P4/P5, sans extrapolation

Cette baseline explique le diagnostic initial. Les livraisons P4/P5 et
l'extension sessions sont decrites plus bas ; `overview_bundle` n'est plus
le lecteur KPI actif lorsque le flag temps reel est allume.
