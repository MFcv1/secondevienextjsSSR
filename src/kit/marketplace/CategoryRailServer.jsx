            ...
            <div className="relative ml-4 flex h-[142px] min-w-0 flex-1 flex-col items-start justify-between overflow-hidden py-1 lg:ml-5 lg:h-[150px] lg:py-1.5 2xl:ml-5 2xl:h-[166px] 2xl:py-2">
              ...
              <span className="relative z-[1] w-full">
                ...
                <span className="mt-3 flex w-full items-center gap-2" aria-hidden="true">
                  <span className={`h-px flex-1 bg-gradient-to-r ${darkMode ? 'from-white/30 via-white/12 to-transparent' : 'from-[#9A654B]/38 via-[#d8c8ba] to-transparent dark:from-[#e6c18a]/32 dark:via-[#e6c18a]/12'}`} />
                  <span className={`h-1 w-1 rounded-full ${darkMode ? 'bg-white/45' : 'bg-[#c6a27e] dark:bg-[#c7a071]'}`} />
                </span>
                <span className={`relative top-[-4px] mt-3 block max-w-[150px] font-sans text-[10.5px] font-normal leading-[1.45] tracking-normal lg:max-w-[158px] lg:text-[11px] 2xl:max-w-[178px] 2xl:text-[11.5px] ${darkMode ? 'text-white/58' : 'text-[#6b6259] dark:text-[#c8bbaa]/68'}`}>
                  {descriptions[cat.id]}
                </span>
              </span>
            </div>
