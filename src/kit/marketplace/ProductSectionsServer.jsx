...
const restorationProjects = [
  { title: 'La Commode Oubliee', tag: 'Renovation Complete', desc: 'Sablage delicat et peinture Celadon.', avant: '/images/before-after/avant-gallery.webp', avantAvif: '/images/before-after/avant-gallery.avif', apres: '/images/before-after/apres-gallery.webp', apresAvif: '/images/before-after/apres-gallery.avif' },
  { title: "La Console d'Epoque", tag: 'Sablage & Patine', desc: 'Sublimation du veinage naturel du chene.', avant: '/images/before-after/avantu-gallery.webp', avantAvif: '/images/before-after/avantu-gallery.avif', apres: '/images/before-after/apresu-gallery.webp', apresAvif: '/images/before-after/apresu-gallery.avif' },
    ...
    <section className={`gallery-deferred-render before-after-industrial before-after-premium ${darkMode ? 'before-after-premium--dark' : ''} relative flex w-full items-center overflow-hidden px-3 py-10 sm:px-5 sm:py-12 md:min-h-[690px] md:px-7 md:py-14 lg:min-h-[760px] lg:px-8 lg:py-16 2xl:min-h-[780px] 2xl:px-10 dark:bg-[#0e0d0c] ${darkMode ? 'bg-[#141210]' : 'bg-[#efe6d8]'}`}>
      ...
      <div className={`before-after-premium-shell relative mx-auto w-full max-w-[1480px] overflow-hidden rounded-[26px] p-[1px] shadow-[0_30px_86px_-68px_rgba(37,29,22,0.56),0_10px_30px_-28px_rgba(124,88,55,0.38)] ring-1 dark:bg-[#19140f] dark:ring-[#3a3027]/85 dark:shadow-[0_30px_86px_-72px_rgba(0,0,0,0.96)] ${darkMode ? 'bg-[#19140f] ring-[#3a3027]/85' : 'bg-gradient-to-br from-[#d9c4ae] via-[#fffaf3] to-[#d1b99e] ring-[#dac6b0]'}`}>
        ...
        <div className={`before-after-premium-copy before-after-premium-copy--warm relative flex min-h-[320px] flex-col justify-center border-b p-5 sm:min-h-[340px] sm:p-7 md:p-8 lg:min-h-[430px] lg:border-b-0 lg:border-r lg:p-8 xl:p-9 2xl:p-10 dark:border-[#302820] dark:bg-[#181511] ${darkMode ? 'border-[#332b23] bg-[#1d1a16]' : 'border-[#63483a] bg-[#49342b]'}`}>
          ...
          />
          <div className={`before-after-premium-kicker mb-7 flex items-center gap-3 font-sans text-[9px] font-bold uppercase tracking-[0.24em] sm:mb-9 ${darkMode ? 'text-[#d8ad73]' : 'text-[#e1ba8c]'}`}>
            <span className={`h-px w-8 ${darkMode ? 'bg-[#d8ad73]/55' : 'bg-[#e1ba8c]/60'}`} />
          ...
          <h2 className={`before-after-premium-title max-w-[650px] font-serif text-[clamp(3.1rem,7.6vw,5.2rem)] font-semibold leading-[0.88] tracking-normal lg:text-[clamp(3.35rem,4.15vw,5rem)] dark:text-[#fbf2e7] ${darkMode ? 'text-[#fbf2e7]' : 'text-[#fff7eb]'}`}>
            ...
            <span className={`before-after-title-line block pt-1 font-light italic ${darkMode ? 'text-[#d8ad73]' : 'text-[#dfa567]'}`}>c'est possible&nbsp;!</span>
          </h2>
          <p className={`before-after-premium-description mt-8 max-w-[520px] font-sans text-[13px] leading-[1.6] sm:mt-9 sm:text-[13.5px] md:text-[14px] dark:text-[#d5c8b9]/78 ${darkMode ? 'text-[#d5c8b9]/78' : 'text-[#eedccc]/78'}`}>
          ...
          <Link href="/a-propos" prefetch={false} className={`before-after-premium-cta group mt-8 inline-flex min-h-[48px] w-full max-w-[270px] items-center justify-between overflow-hidden rounded-full px-2 pl-5 font-sans text-[8.5px] font-extrabold uppercase tracking-[0.16em] ring-1 transition-all duration-700 sm:mt-9 sm:min-h-[56px] sm:max-w-[330px] sm:px-2.5 sm:pl-7 sm:text-[10px] dark:bg-[#f8efe2] dark:text-[#18130f] dark:ring-white/20 ${darkMode ? 'bg-[#f8efe2] text-[#18130f] ring-white/20' : 'bg-[#f8e7d1] text-[#3c271c] ring-[#e4bc92]'}`}>
        ...
        <div className={`before-after-premium-visual relative flex min-h-full flex-col justify-center gap-4 p-2 sm:p-4 md:gap-4 md:p-5 lg:p-6 dark:bg-[#181511] ${darkMode ? 'bg-[#1d1a16]' : 'bg-[#fffaf3]'}`}>
          <div>
