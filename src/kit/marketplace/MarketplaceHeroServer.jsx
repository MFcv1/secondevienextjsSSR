    ...
    <section className="relative flex h-[492px] w-full flex-col items-center justify-center overflow-hidden md:h-[65vh] md:min-h-[500px]" data-gallery-hero>
      ...
      <div className="relative z-10 flex w-full max-w-4xl -translate-y-6 flex-col items-center px-4 text-center md:-translate-y-12">
        ...
        <div className="relative">
          ...
          <div className="relative mx-auto flex w-full max-w-[292px] flex-col items-stretch justify-center gap-3 min-[380px]:max-w-none min-[380px]:flex-row min-[380px]:items-center min-[380px]:gap-3.5 md:top-[8px] md:gap-3">
            <a href="#gallery-pieces" className="hero-cta-particles hero-cta-particles--light hero-cta-particles--static group/heroCta inline-flex h-[40px] w-full items-center justify-between gap-2 rounded-full border pl-5 pr-1.5 text-[#1A1A1A] shadow-[0_10px_24px_rgba(0,0,0,0.14)] transition-[border-color,box-shadow,background-color] duration-700 ease-[cubic-bezier(0.32,0.72,0,1)] active:scale-[0.98] dark:border-[#d8ad73]/30 dark:bg-[#17130f]/88 dark:text-[#f5eadb] dark:shadow-[inset_0_1px_0_rgba(255,255,255,0.07),0_18px_42px_rgba(0,0,0,0.34)] min-[380px]:w-auto md:h-[46px] md:gap-3 md:pl-7 md:pr-1.5 md:shadow-[0_14px_34px_rgba(0,0,0,0.16)]">
              <span className="whitespace-nowrap font-sans text-[8px] font-black uppercase tracking-[0.16em] md:text-[10px] md:tracking-[0.21em]">
                {heroButtonLabel}
              </span>
              <span className="hero-cta-icon flex h-8 w-8 shrink-0 items-center justify-center rounded-full border border-[#1A1A1A]/12 bg-[#F6F2EC] text-[#1A1A1A] dark:border-[#e4ba7e]/24 dark:bg-[#d8ad73] dark:text-[#15110d] md:h-9 md:w-9">
                <ArrowUpRight className="hero-cta-arrow" size={14} strokeWidth={1.7} />
              </span>
            </a>

            <Link href="/devis" prefetch={false} className="hero-cta-particles hero-cta-particles--glass group/heroCta inline-flex h-[40px] w-full items-center justify-between gap-2 rounded-full border pl-5 pr-1.5 text-white shadow-[0_10px_24px_rgba(0,0,0,0.10)] backdrop-blur-sm transition-[border-color,box-shadow,background-color] duration-700 ease-[cubic-bezier(0.32,0.72,0,1)] active:scale-[0.98] dark:border-[#e6c18a]/34 dark:bg-[#120f0b]/38 dark:text-[#f7efe5] dark:shadow-[0_18px_42px_rgba(0,0,0,0.26)] min-[380px]:w-auto md:h-[46px] md:gap-3 md:pl-7 md:pr-1.5 md:shadow-[0_14px_34px_rgba(0,0,0,0.10)]">
              ...
              <span className="hero-cta-icon flex h-8 w-8 shrink-0 items-center justify-center rounded-full border border-white/35 bg-white/10 text-white md:h-9 md:w-9">
                <ArrowUpRight className="hero-cta-arrow" size={14} strokeWidth={1.7} />
              </span>
            </Link>
          </div>
