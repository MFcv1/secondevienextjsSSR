    ...
    <section className="relative flex min-h-[100svh] w-full flex-col bg-[#F9F6F0] p-3 md:p-5 lg:p-7">
      <div className="relative z-20 flex w-full flex-grow items-center overflow-hidden rounded-2xl bg-[#1A1A1A] shadow-[0_30px_60px_rgba(0,0,0,0.3)] md:rounded-3xl">
        <div className="pointer-events-none absolute inset-0 z-0 overflow-hidden">
          <div className="absolute -top-[10%] h-[120%] w-full">
            <img
              src={hero.image}
              sizes="100vw"
              alt="Atelier Seconde Vie par Anais"
              className="absolute inset-0 h-full w-full origin-center object-cover object-[75%_center] opacity-100 brightness-[1.1] contrast-[1.05] saturate-[1.1] md:object-center"
              fetchPriority="high"
            />
          ...
          <div className="absolute bottom-0 left-[10%] top-0 z-10 hidden w-px origin-top bg-[#F9F6F0]/10 md:block" />
          <div className="absolute left-0 right-0 top-[20%] z-10 hidden h-px origin-left bg-[#F9F6F0]/10 md:block" />
        </div>

        <div className="pointer-events-none absolute inset-0 z-30 overflow-hidden mix-blend-normal xl:overflow-visible">
          <div
            className="absolute right-[-5%] top-[5%] z-40 aspect-[3/4] w-[30vw] overflow-hidden shadow-[0_40px_80px_rgba(0,0,0,0.6)] md:right-[2%] md:top-[10%] md:w-[20vw] xl:w-[18vw]"
          ...
          <div
            className="absolute bottom-[-2%] left-[-5%] z-20 h-[30vw] w-[22vw] overflow-hidden drop-shadow-[0_20px_40px_rgba(0,0,0,0.8)] md:-left-[2%] md:bottom-[2%] md:h-[16vw] md:w-[12vw] xl:left-[2%] xl:h-[18vw] xl:w-[14vw]"
          ...
          <div
            className="absolute right-[-5%] top-[72%] z-40 h-[28vw] w-[35vw] overflow-hidden shadow-2xl md:right-[15%] md:top-[65%] md:h-[16vw] md:w-[22vw] xl:right-[18%]"
        ...
        <div className="relative z-40 mx-auto w-full max-w-[1600px] px-6 pt-24 md:px-12 md:pt-0 lg:px-20">
          <div className="z-50 flex max-w-[700px] flex-col justify-center">
            <div className="mb-8 flex w-full gap-4 md:mb-10 md:items-center">
            ...
            <h1 className="mb-8 ml-[-5px] font-serif text-5xl leading-[0.95] tracking-tighter text-[#F9F6F0] md:text-7xl lg:text-[7.5rem]">
              {hero.title} <br />
              <span className="font-light italic text-[#A68A64]">{hero.highlight}</span>.
            </h1>
            <p className="mb-10 max-w-[50ch] border-l border-[#A68A64]/30 pl-4 font-sans text-base font-light leading-relaxed text-[#B3AEA3] text-pretty md:mb-12 md:pl-6 md:text-xl">
              {hero.description}
            </p>
            <div className="pt-4">
...
function ArchSection() {
  return (
    <section className="relative z-10 w-full bg-[#F9F6F0] pt-0 md:pt-[15vh]">
      <div className="relative w-full bg-[#F9F6F0]">
        <div className="relative h-screen w-full overflow-hidden">
          <div className="absolute inset-0 overflow-hidden bg-[#F9F6F0]">
            <div
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center px-4 text-[#F9F6F0]">
            <div className="relative overflow-hidden rounded-[2rem] border border-[#F9F6F0]/20 bg-[#1A1A1A]/20 p-5 text-center shadow-2xl backdrop-blur-md md:rounded-[3rem] md:p-12 lg:p-16">
              <div className="relative z-10 mb-6 flex w-full items-center justify-center gap-4 md:mb-10">
              ...
              <h2 className="relative z-10 flex flex-col items-center font-serif text-[10vw] leading-[0.85] tracking-tighter drop-shadow-2xl md:text-[9vw] lg:text-[7vw] xl:text-[7rem]">
                <span className="mb-2 block font-light italic text-[#A68A64]">La Galerie</span>
                <span className="block pr-4">des Merveilles</span>
              </h2>
              <p className="relative z-10 mx-auto mt-10 max-w-[45ch] text-center text-sm font-light leading-relaxed text-[#E8E3DA]/80 text-pretty md:text-base lg:text-lg">
          ...
          <div className="absolute left-6 top-8 flex flex-col gap-3 md:left-12 md:top-16">
            <div className="flex items-center gap-4">
              <span className="font-sans text-[10px] font-bold uppercase tracking-[0.4em] text-white md:text-xs">La Galerie</span>
              <div className="h-px w-8 bg-white md:w-16" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="relative z-20 mx-auto -mt-[8vh] max-w-[1600px] rounded-t-[3rem] bg-[#F9F6F0] px-6 pb-[25vh] pt-[15vh] shadow-[0_-20px_60px_rgba(0,0,0,0.1)] md:rounded-t-[4rem] md:px-12 lg:px-20">
        <div className="relative z-10 flex flex-col gap-[10vh] md:gap-[25vh]">
          {items.map((item, index) => (
            <div key={item.title} className={`flex w-full flex-col items-center gap-12 md:gap-20 lg:gap-32 ${item.reverse ? 'md:flex-row-reverse' : 'md:flex-row'}`}>
              <div className="w-full md:w-[60%] lg:w-[55%]">
                <div className="w-full rounded-[2rem] bg-[#EDE8E0] p-4 shadow-[0_40px_80px_-20px_rgba(0,0,0,0.1)] md:rounded-[2.5rem] md:p-6 lg:p-8">
                  <div className="mx-auto aspect-[4/5] w-full overflow-hidden rounded-[1.5rem] bg-[#E8E3DA]">
              ...
              <div className={`flex w-full flex-col justify-center space-y-6 text-center md:w-[40%] lg:w-[45%] ${item.reverse ? 'md:items-end md:text-right' : 'md:items-start md:text-left'}`}>
                <div className="py-1 text-sm font-serif italic text-[#A68A64] md:text-base">N 0{index + 1}</div>
                <h3 className="py-1 font-serif text-4xl leading-[1.1] tracking-tight text-[#1A1A1A] text-pretty md:text-5xl xl:text-6xl">{item.title}</h3>
                <p className="mx-auto max-w-[40ch] py-1 text-base font-light leading-relaxed text-[#5A5550] text-pretty md:mx-0 md:max-w-none md:text-lg">{item.desc}</p>
                <div className="pt-4">
    ...
    <section id="atelier" className="relative z-[30] flex min-h-[100svh] w-full flex-col bg-transparent p-3 md:p-5 lg:p-6">
      <div className="relative flex w-full flex-grow flex-col overflow-hidden rounded-b-2xl rounded-t-3xl border-t border-black/5 bg-[#F9F6F0] px-8 py-16 shadow-[0_-30px_60px_rgba(0,0,0,0.15)] md:rounded-b-[2.5rem] md:rounded-t-[3rem] md:px-16 md:py-24 lg:px-24">
        ...
        <div className="relative z-10 mb-16 max-w-4xl md:mb-24">
          ...
          <h2 className="mb-8 font-serif text-5xl uppercase leading-[0.9] tracking-tighter text-[#1A1A1A] md:text-7xl lg:text-[6rem]">
            L'ART <span className="font-light lowercase italic text-[#A68A64]">de sauvegarder</span> LA MATIERE.
          </h2>
          <p className="max-w-2xl text-sm font-light leading-relaxed text-[#5A5550] md:text-lg">
        ...
        <div className="relative z-10 grid flex-grow grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
          {steps.map((step) => {
            ...
            return (
              <article key={step.id} className="group relative flex flex-col justify-between overflow-hidden rounded-[2rem] border border-black/5 bg-[#F9F6F0]/80 p-8 shadow-sm transition-all duration-[600ms] hover:-translate-y-2 hover:shadow-[0_40px_80px_rgba(0,0,0,0.08)]">
...
function InterludeSection() {
  ...
  return (
    <section id="valeurs" className="relative z-0 flex w-full flex-col items-center justify-center overflow-hidden bg-[#F9F6F0] pb-32 pt-16 md:py-40">
...
function InstagramSection() {
  return (
    <section className="relative z-30 -mt-[5vh] flex w-full flex-col bg-[#111111] pb-[20vh] md:mt-0">
      <div className="relative mx-auto flex w-full flex-grow flex-col px-6 pb-32 pt-[15vh] md:px-12 md:pt-[20vh] lg:px-20">
        ...
        <div className="relative z-10 mx-auto flex w-full max-w-[1600px] flex-col">
          <div className="mb-16 flex flex-col justify-between gap-12 md:mb-24 xl:flex-row xl:items-end">
...
function FaqSection({ items }) {
  return (
    <section className="relative z-40 -mt-[15vh] flex w-full flex-col overflow-hidden bg-white shadow-[0_-30px_60px_rgba(0,0,0,0.2)]">
...
function ContactSection() {
  return (
    <section id="vitrine-contact" className="relative z-20 w-full overflow-hidden pb-0" style={{ marginTop: '-15vh', marginBottom: '-1px' }}>
