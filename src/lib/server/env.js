...
export const publicEnv = {
  ...
  publicCatalogSource: process.env.PUBLIC_CATALOG_SOURCE || 'legacy',
  catalogCanaryEnabled: process.env.CATALOG_CANARY_ENABLED === 'true',
  catalogEmergencyFirestoreFallback: process.env.CATALOG_EMERGENCY_FIRESTORE_FALLBACK === 'true',
  catalogSnapshotBucket: process.env.CATALOG_SNAPSHOT_BUCKET || '',
