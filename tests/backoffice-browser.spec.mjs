...
async function bundle() {
  ...
  await add('virtual:image', `module.exports = function Image(){return null;}`);
  ...
  const entry = await add('virtual:entry', `
    ...
    window.renderView=(name, revision=0)=>root.render(React.createElement(({Dashboard,Invoices,Quotes})[name], {user:{uid:'local-admin'},onLoadCatalog:()=>Promise.resolve(),backOfficeReadyAt:revision}));
