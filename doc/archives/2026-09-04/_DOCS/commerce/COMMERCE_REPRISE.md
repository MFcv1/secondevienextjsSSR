> ARCHIVE — version remplacée le 2026-09-04 de `_DOCS/commerce/COMMERCE_REPRISE.md`.
> Les règles, contrôles et chiffres décrivent leurs dates d'origine, pas l'état courant.
> Référence maintenue : [COMMERCE_REPRISE.md](../../../../../_DOCS/commerce/COMMERCE_REPRISE.md).
...
[RECETTE_CLIENT_ADMIN.md](../../../../../_DOCS/quality/RECETTE_CLIENT_ADMIN.md), avec registre
...
4. [COMMERCE_STRIPE.md](../../../../../_DOCS/commerce/COMMERCE_STRIPE.md);
5. le présent plan;
...
- retirer de `COMMERCE_STRIPE.md` les formulations historiques presentees
  comme etat courant;
- relier la synthese, le plan et `COMMERCE_REPRISE.md`;
...
- `COMMERCE_REPRISE.md`, `_DOCS/README.md`, `AGENTS.md` et `map.md` ne le referencent plus;
