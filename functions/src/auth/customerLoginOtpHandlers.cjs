...
function createCustomerLoginOtpHandlers({ admin, HttpsError, getRateLimitClientIp, OTP_HMAC_SECRET, getSiteUrl, timestampFromNow, SYSTEM_DOC_RETENTION_DAYS, getTransactionalEmailRuntime, logFunctionPerf }) {
...
return { sendCustomerLoginOtpHandler, verifyCustomerLoginOtpHandler };
}
module.exports = { createCustomerLoginOtpHandlers };
