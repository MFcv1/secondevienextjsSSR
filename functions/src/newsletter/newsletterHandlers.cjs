...
function createNewsletterHandlers({ admin, HttpsError, getRateLimitClientIp, getSiteUrl, getEmailRuntime }) {
...
return { drawNewsletterRewardHandler, claimNewsletterRewardHandler, listMyNewsletterRewardsHandler };
}
