...
function createCheckoutHandlers({ admin, HttpsError, normalizeFirestoreId, resolveCheckoutEmail, checkoutRuntime }) {
...
return { createCheckoutHandler, createResumeCheckoutHandler, normalizeFixtureRequest };
}
