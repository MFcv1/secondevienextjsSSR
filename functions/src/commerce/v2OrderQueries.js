...
const { createCustomerOrderQueries } = require('./customerOrderQueries.cjs');
const { normalizePageSize, shouldHideRefundConfirmation, serializeOrder, serializeRefundAttempt, serializeCommerceDocument, serializeCustomerReturnRequest, paginatedQuery, createListMyOrdersHandler } = createCustomerOrderQueries({
    admin, HttpsError: functions.https.HttpsError, normalizeFirestoreId
});
