...
function createOrderStatusHandler({ admin, HttpsError, normalizeFirestoreId, assertGuestCheckoutOtpVerified, normalizeGuestCheckoutEmail, logFunctionPerf }) {
...
const getOrderStatusClientHandler = async (data, context) => {
...
return getOrderStatusClientHandler;
}
module.exports = { createOrderStatusHandler };
